...
**Maintainer:** Sayali Sanjay Sonawane
**Status:** Operational
...
Found 5 CSV files:
  Loading: Monday-WorkingHours.csv... [OK] 371,749 records
  Loading: Tuesday-WorkingHours.csv... [OK] 322,003 records
  ...
  Total: 2,100,814 records

PREPROCESSING
1. Removing non-predictive features... [OK] Dropped 6 columns
2. Handling missing values... [OK] Removed 0 missing values
3. Replacing infinite values... [OK] Replaced 1,234 infinite values
4. Processing labels... [OK] Binary classification (BENIGN vs ATTACK)
5. Encoding labels... [OK] Encoded 2 classes
6. Scaling features... [OK] Scaled 78 features

TRAINING: RANDOM FOREST
Training on 1,680,651 samples... [OK] Completed in 127.45s
...
|--------|--------|--------|
| Accuracy | >99% | [OK] ACHIEVED |
| False Positive Rate | <1% | [OK] ACHIEVED |
| Inference Latency | <100ms | [OK] ACHIEVED |
| Model Size | <500MB | [OK] ACHIEVED |
...
**Contact:** ssonawanesayali@gmail.com
**LinkedIn:** http://www.linkedin.com/in/sonawanesayali/

## About the Developer

Sayali Sanjay Sonawane is a CISA-certified Technology Audit and Information Security Risk professional with over 4 years of experience in ITGC assessments, technology risk evaluations, and data analytics. She specializes in leveraging AI-powered automation and advanced analytics to enhance security operations and audit quality across enterprise environments. This pipeline serves as a core component for automated threat detection and risk mitigation within the AI-SOC framework.

Original project architecture by Abdul Bari. Current maintenance and pipeline optimization by Sayali Sanjay Sonawane.
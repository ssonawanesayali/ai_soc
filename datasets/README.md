...
|---------|--------------|----------------|---------------------|
| CICIDS2017 | Yes - Free | Check terms | Yes |
| UNSW-NB15 | Yes - Free | No | Yes |
| CICIoT2023 | Yes - Free | Check terms | Yes |
| LogHub | Yes - Free | Yes - Free (OSS) | Yes |
...
This project is maintained by **Sayali Sanjay Sonawane**.

Sayali is a CISA-certified Technology Audit and Information Security Risk professional with over 4 years of experience in ITGC assessments, technology risk evaluations, and security control testing. Her work focuses on leveraging data analytics and AI-powered automation to enhance security operations and audit quality.

...
â”‚   Wazuh     â”‚â”€â”€â”€â”€â”€â”€> â”‚   Shuffle   â”‚â”€â”€â”€â”€â”€â”€> â”‚ Alert Triage â”‚
â”‚   Manager   â”‚ Alert  â”‚    SOAR     â”‚ Webhookâ”‚   Service    â”‚
...
**Data Flow:**
1. Wazuh detects security event â†’ generates alert
2. Shuffle receives alert webhook â†’ forwards to `/analyze` endpoint
3. LLM analyzes alert â†’ returns structured JSON response
...
Condition: severity == "critical" OR "high"
  â†“
  Yes â†’ Create TheHive case (priority: urgent)
  No  â†’ Log to dashboard
```
...
Initial development was contributed by Abdul Bari. This project is currently maintained by Sayali Sanjay Sonawane (ssonawanesayali@gmail.com).
...
This project is actively maintained by Sayali Sanjay Sonawane, a Technology Audit and Information Security Risk professional. With over 4 years of experience in ITGC assessments, application controls, SDLC reviews, and security risk evaluations, Sayali focuses on leveraging AI-powered automation to enhance audit quality and drive remediation in security operations.
